...
namespace ConsoleApp3
{
    ...
    {
        public int daraginGulleTutum { get; set; }
        public  int daragdakiGulleSayi; { get; set; }
        public int daraginBowalmaSaniyesi { get; set; }
        public bool otomatikAtiwModu { get; set; }
